...
in 0.25`-.35 sec (i.e. 350-600 images /sec). The model reaches ~86%

On a single Geforce 1080Ti, cifar10_train.py processes a single batch of 128 images
in 0.011-0.022 sec (i.e. 5800-12000 images/ sec).
...
def evaluate():
    ...
    with tf.Graph().as_default() as g:
        # Get images and lebels for CIFAR-10.
        eval_data = FLAGS.eval_data == 'test'
        images, labels = cifar10.inputs(eval_data=eval_data)

        # Build a Graph that computes the logits predictions form the
        # inference model.
